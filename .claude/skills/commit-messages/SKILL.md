...
description: Personal git commit message format — use whenever writing a commit message in any project, unless the project's own CLAUDE.md or CONTRIBUTING guide specifies a different convention.
---
...
5. <description> should be both simple, short, and clear about what the commit does
